...
var ReactTable = function (_React$Component) {
  ...
  _createClass(ReactTable, [{
    ...
    value: function render() {
      ...
      var givenRows = _props.rows;
      var columns = _props.columns;
      var _props$className = _props.className;
      var className = _props$className === undefined ? '' : _props$className;
      var rowKey = _props.rowKey;
      var sort = _props.sort;
      var _props$renderHeaderCo = _props.renderHeaderColumn;
      var renderHeaderColumn = _props$renderHeaderCo === undefined ? ReactTable.defaultHeaderRenderer : _props$renderHeaderCo;
      var _props$renderBodyColu = _props.renderBodyColumn;
      var renderBodyColumn = _props$renderBodyColu === undefined ? ReactTable.defaultBodyRenderer : _props$renderBodyColu;
