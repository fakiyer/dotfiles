...
module.exports = function handleComponentBind(options) {
    ...
    if (rendererModule && rendererModule !== componentModule || !rendererModule && componentModule) {
        componentProps._X_ = isSplit = true;
    }

    if (isImplicitComponent) {
        componentProps.ad_ = true;
    }
    ...
    if (componentModule) {
        ...
        componentProps._l_ = componentTypeNode;
    ...
    if (flags) {
        context.root.appendChild(builder.assignment(builder.memberExpression(builder.identifier('__component'), builder.identifier('_e_')), builder.literal(flags), '|='));
    }
