...
function format(options) {
  ...
  var eslintConfig = (0, _lodash2.default)({}, options.eslintConfig, getESLintConfig(filePath));

  var prettierOptions = (0, _lodash2.default)({}, filePath && { filepath: filePath }, getPrettierConfig(filePath), options.prettierOptions);
...
function getESLintConfig(filePath) {
  ...
  logger.trace(_commonTags.oneLine`
    ...
    `);
  var cliEngine = getESLintCLIEngine("eslint", eslintOptions);
  try {
